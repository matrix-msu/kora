...
class GeneratedListField extends BaseField {
    ...
    */
    ...
    public function massAssignRecordField($field, $formFieldValue, $request, $overwrite=0) {
        ...
        $ridsValue = GeneratedListField::where('flid','=',$field->flid)->where('options','!=','')->where('options','!=',NULL)->pluck('rid')->toArray();
    ...
    public function rollbackField($field, Revision $revision, $exists=true) {
        ...
        if(!isset($revision->oldData[Field::_GENERATED_LIST][$field->flid]['data']))
            return null;
