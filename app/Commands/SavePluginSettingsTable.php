...
class SavePluginSettingsTable extends Command implements SelfHandling, ShouldQueue
{
    ...
    public function handle() {
        ...
        DB::table('plugin_settings')->chunk(500, function($pluginSettings) use ($table_path, $row_id) {
            $count = 0;
