...
class ExportController extends Controller {
     ...
     * @return string | null, if the format is valid, output of python script, if no errors occur this will be
     *                        the absolute file path of the export file output.
     */
    public static function exportWithRids(array $rids, $format = ExportController::JSON) {
