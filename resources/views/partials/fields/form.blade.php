...
<div class="form-group">
    ...
    @if ($type == 'edit')
        {!! Form::text('name', null, ['class' => 'text-input', 'placeholder' => 'Enter the field name here']) !!}
    @else
...
<div class="form-group mt-xl">
    ...
    <div class="check-box">
        <input type="checkbox" value="1" id="preset" class="check-box-input" name="searchable" {{$field->required ? 'checked': ''}} />
        <div class="check-box-background"></div>
        <span class="check"></span>
...
<div class="form-group mt-xl">
    ...
    <div class="check-box">
        <input type="checkbox" value="1" id="preset" class="check-box-input" name="extsearch" {{$field->required ? 'checked': ''}} />
        <div class="check-box-background"></div>
        <span class="check"></span>
...
<div class="form-group mt-xl">
    ...
    <div class="check-box">
        <input type="checkbox" value="1" id="preset" class="check-box-input" name="viewable" {{$field->required ? 'checked': ''}} />
        <div class="check-box-background"></div>
        <span class="check"></span>
...
<div class="form-group mt-xl">
    ...
    <div class="check-box">
        <input type="checkbox" value="1" id="preset" class="check-box-input" name="viewresults" {{$field->required ? 'checked': ''}} />
        <div class="check-box-background"></div>
        <span class="check"></span>
...
<div class="form-group mt-xl">
    ...
    <div class="check-box">
        <input type="checkbox" value="1" id="preset" class="check-box-input" name="extview" {{$field->required ? 'checked': ''}} />
        <div class="check-box-background"></div>
        <span class="check"></span>
