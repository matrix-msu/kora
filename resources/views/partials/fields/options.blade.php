...
{!! Form::hidden('desc',$field['description']) !!}
...
<div class="form-group mt-xl">
    ...
    {!! Form::text('altName', $field['alt_name'], ['class' => 'text-input' . (array_key_exists("altName", $errors->messages()) ? ' error' : ''), 'placeholder' => 'Enter the alternative field name here (optional)', 'autofocus']) !!}
</div>

<div class="form-group mt-xl">
    {!! Form::label('desc', 'Description') !!}
    <span class="error-message">{{array_key_exists("desc", $errors->messages()) ? $errors->messages()["desc"][0] : ''}}</span>
    {!! Form::textarea('desc', $field['description'], ['class' => 'text-area', 'placeholder' => "Enter the field's description here (max. 255 characters)"]) !!}
...
<div class="form-group mt-xl">
    ...
    <div class="check-box">
        <input type="checkbox" value="1" id="preset" class="check-box-input" name="advsearch" {{$field['advanced_search'] ? 'checked': ''}} />
        <div class="check-box-background"></div>
        <span class="check"></span>
...
<div class="form-group mt-xl">
    ...
    <div class="check-box">
        <input type="checkbox" value="1" id="preset" class="check-box-input" name="extsearch" {{$field['external_search'] ? 'checked': ''}} />
        <div class="check-box-background"></div>
        <span class="check"></span>
...
<div class="form-group mt-xl">
    ...
    <div class="check-box">
        <input type="checkbox" value="1" id="preset" class="check-box-input" name="viewresults" {{$field['viewable_in_results'] ? 'checked': ''}} />
        <div class="check-box-background"></div>
        <span class="check"></span>
...
<div class="form-group mt-xl">
    ...
    <div class="check-box">
        <input type="checkbox" value="1" id="preset" class="check-box-input" name="extview" {{$field['external_view'] ? 'checked': ''}} />
        <div class="check-box-background"></div>
        <span class="check"></span>
