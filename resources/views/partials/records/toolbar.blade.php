<div class="toolbar hidden">
  <div class="left delete-multiple-records-js ml-m">
    <i class="icon icon-trash ml-m"></i>
    <span class="count ml-xxs"></span>
  </div>
  <div class="middle">
    <span><a class="batch-assign" href="{{ action('RecordController@showSelectedAssignmentView',['pid' => $form->pid, 'fid' => $form->fid]) }}"><i class="icon icon-zap mr-xxs"></i>Batch Assign<span class="count ml-xxs"></span></a></span>
