                ...
                <div class="card file-card file-card-js">
                    ...
                    <div class="header">
                        ...
                        <div class="card-toggle-wrap">
                            <a href="#" class="file-delete upload-filedelete-js ml-sm tooltip" tooltip="Remove Audio" data-url="{{ url("deleteTmpFile/$form->id/$flid/".urlencode($tmpFileDir)."/".urlencode($name)) }}">
