<?php
    ...
    if($editRecord && $hasData) {
        $names = explode('[!]',$typedField->model);
                ...
                <div class="card file-card file-card-js">
                    ...
                    <div class="header">
                        ...
                        <div class="card-toggle-wrap">
                            <a href="#" class="file-delete upload-filedelete-js ml-sm tooltip" tooltip="Remove 3D Model" data-url="{{ url('deleteTmpFile/'.$folder.'/'.urlencode($file)) }}">
