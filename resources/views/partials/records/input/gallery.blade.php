        ...
        <div class="file-cards-container file-cards-container-js filenames-{{$flid}}-js preset-clear-file-js">
            @foreach($value as $index => $file)
                <div class="card file-card file-card-js">
                    <input type="hidden" name="{{$flid}}[]" value ="{{$file['name']}}">
                    <div class="header">
                        <div class="left">
                        ...
                        <div class="card-toggle-wrap">
                            <a href="#" class="file-delete upload-filedelete-js ml-sm tooltip" tooltip="Remove Image" data-url="{{ url("deleteTmpFile/$form->id/$flid/".urlencode($file['name'])) }}">
