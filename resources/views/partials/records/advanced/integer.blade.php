...
<div class="form-group mt-xl">
    ...
    <input class="text-input" type="number" name="{{$inputID}}_left" placeholder="Enter left bound (leave blank for -infinity)" step="1">
</div>
<div class="form-group mt-sm">
    <input class="text-input" type="number" name="{{$inputID}}_right" placeholder="Enter right bound (leave blank for infinity)" step="1">
</div>
<div class="form-group mt-sm">
