<li class="kora_nav_item">
    <a href="#" class="kora_nav_item_title">Dashboard<img class="kora_nav_icon_post_text" src="{{ env('BASE_URL') }}assets/images/menu_arrow.svg"></a>
...
<li class="kora_nav_item">
    <a href="#" class="kora_nav_item_title">Projects<img class="kora_nav_icon_post_text" src="{{ env('BASE_URL') }}assets/images/menu_arrow.svg"></a>
    <ul class="kora_nav_sub_menu">
        <li class="kora_nav_sub_menu_item">
        ...
        @if(sizeof($allowed_projects) > 1)
            <li class="kora_nav_sub_menu_item">
                <a href='#' class="kora_nav_sub_menu_item_title">Jump to Project<img class="kora_nav_icon_post_text" src="{{ env('BASE_URL') }}assets/images/menu_plus.svg"></a>
