...
<div class="list_option_form">
    ...
    <div>
        {!! Form::label('desc', trans('fields_options_geolocator.desc').': ') !!}
...
<div class="form-group">
    ...
    {!! Form::select('map', ['No' => trans('fields_options_geolocator.no'),'Yes' => trans('fields_options_geolocator.yes')], 'No', ['class' => 'form-control']) !!}
</div>

<div class="form-group">
    {!! Form::label('view',trans('fields_options_geolocator.data').': ') !!}
    {!! Form::select('view', ['LatLon' => 'Lat Long','UTM' => 'UTM Coordinates','Textual' => trans('fields_options_geolocator.text')], 'LatLon', ['class' => 'form-control']) !!}
</div>
