...
<!-- Section 1 -->
<section class="database-section" page-name="Database">
...
<!-- Section 2 -->
<section class="admin-section hidden" page-name="Admin">
...
<!-- Section 3 -->
<section class="mail-section hidden" page-name="Mail">
...
<!-- Section 4 -->
<section class="recaptcha-section hidden" page-name="Recaptcha">
