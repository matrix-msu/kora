...
@section('content')
    <h1>Create a New Field Options Preset</h1>
    <hr/>


    <div class="form-group">
        <label for="preset_type">Type</label>
        <select name="preset_type" id="preset_type" class="form-control">
            <option value="default">Select a type of preset</option>
            <option value="text">Text Regular Expressions</option>
            <option value="list">List Options</option>
            <option value="schedule">Schedule Events</option>
            <option value="geolocator">Geolocator Locations</option>
        </select>
    </div>
    ...
    <div style="display:none" id="preset_list" class="list_option_form form-group">
        <label for="preset_list_options">Options:</label>
    ...
    <div class="form-group">
        <input onclick="CreatePreset()" type="submit" class="btn btn-primary form-control" id="submit" value="Save New Preset">
    </div>
        ...
        function CreatePreset() {
            ...
            $.ajax({
                ...
                error: function(result){
                    alert("Sorry, the preset could not be saved.  Make sure you added at least one option and entered a name.");
                }
            });
        }
