<div class="panel panel-default">
    ...
    <div id="input_collapse_{{$field->flid}}" style="display: none;">
        <div class="panel-body">
            <label for="{{$field->flid}}_input">{{trans('advanced_search.filename')}}: </label>
            <input class="form-control" type="text" name="{{$field->flid}}_input">
            <br/>{{trans('advanced_search.input_text')}}: <span id="{{$field->flid}}_valid_text">{{trans('advanced_search.invalid')}}</span>.
        </div>
